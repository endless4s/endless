...
trait Deployer {
  ...
  /** This function brings everything together and delivers a `Resource` with the repository
    ...
    * the usual pekko ask timeout, actor system and cluster sharding extension.
    *
    ...
    *   hook to further customize pekko `EventSourcedBehavior`. By default the behavior enforces
