...
@scaladoc[EntityIDCodec](endless.core.protocol.EntityIDCodec) can encode/decode the entity ID into/from `String` for transmission over the wire together with commands. 